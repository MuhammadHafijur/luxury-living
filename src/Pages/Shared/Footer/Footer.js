          ...
          <div className="flex-grow flex flex-wrap mx-auto -mb-10 md:text-left text-center order-first">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-white hover:text-gray-200">Project</a>
                </li>
                <li>
                  <a className="text-white hover:text-gray-200">Our Team</a>
                </li>
                <li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-white hover:text-gray-200">Quick Links</a>
                </li>
                <li>
                  <a className="text-white hover:text-gray-200">Rentals</a>
                </li>
                <li>
                  <a className="text-white hover:text-gray-200">Sales</a>
                </li>
                <li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <div className="mb-10">
                <p className="text-gray-200">
                  ...
                  You can use Griffin Residential to market your
                </p>
              </div>
            </div>
          </div>
